         ...
         reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "🇹🇷 𝖲𝖺𝗁𝗂𝗉", url="http://t.me/Terazikadinii"
                    )
                ]
      ...
      reply_markup=InlineKeyboardMarkup(
             [
                 [
                     ...
                     InlineKeyboardButton(
                         "📩 𝐒𝐚𝐡𝐢𝐩", url="http://t.me/Terazikadinii")
                 ]
             ]
         )
    )
...
async def herkes(_, query: CallbackQuery):
    ...
    reply_markup=InlineKeyboardMarkup(
             [
                 [
                     InlineKeyboardButton(
                         "🇹🇷 𝖠𝗌𝗂𝗌𝗍𝖺𝗇", url="http://t.me/Dilberanmusicasistan")
                 ],
                 [
                     InlineKeyboardButton(
...
async def admin(_, query: CallbackQuery):
    ...
    reply_markup=InlineKeyboardMarkup(
             [
                 [
                     InlineKeyboardButton(
                         "⚙ Geliştirici", url="http://t.me/Terazikadinii")
                 ],
                 [
                     InlineKeyboardButton(
         ...
         reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "🇹🇷 𝖲𝖺𝗁𝗂𝗉", url=f"http://t.me/Terazikadinii"
                    )
                ]
